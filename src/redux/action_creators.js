...
const actionGetAllWinningEntries = (entriesList) => ({ type: GET_ALL_WINNING_ENTRIES, winningEntries: entriesList });
...
const actionShowConfirmDeleteModal = (toggle) => ({
    type: SHOW_CONFIRM_DELETE_MODAL,
    "showConfirmDeleteModal": toggle
});
